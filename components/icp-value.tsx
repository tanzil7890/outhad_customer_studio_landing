    ...
    <section id="icp" className="bg-[hsl(var(--app-background))] py-16 sm:py-20 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-12">
          ...
          <p className="mt-3 text-sm sm:text-base text-[hsl(var(--app-text-muted))]">Losing 70-98% of traffic to anonymity? Convert them in-session, before they leave.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-xl border border-[hsl(var(--app-border))] bg-[hsl(var(--app-surface))]/60 p-6">
            ...
            <ul className="list-disc pl-5 space-y-1 text-sm text-[hsl(var(--app-text))]">
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-xl border border-[hsl(var(--app-border))] bg-[hsl(var(--app-surface))]/60 p-6">
            ...
            <p className="text-sm text-[hsl(var(--app-text))]">
