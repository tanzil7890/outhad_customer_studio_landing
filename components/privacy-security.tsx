    ...
    <section id="privacy" className="bg-[hsl(var(--app-background))] py-16 sm:py-20 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-12">
          ...
          <p className="mt-3 text-sm sm:text-base text-[hsl(var(--app-text-muted))]">Privacy‑first growth, built for modern compliance needs.</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          {items.map((t, i) => (
            <motion.div
              ...
              className="rounded-xl border border-[hsl(var(--app-border))] bg-[hsl(var(--app-surface))]/60 p-4 text-sm text-[hsl(var(--app-text))]"
            >
              {t}
            </motion.div>
          ))}
