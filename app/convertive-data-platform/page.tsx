    ...
    <div className="min-h-screen bg-[#FAFAF8] pt-44 sm:pt-52">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <section className="text-center lg:text-left mb-14">
          <p className="text-xs uppercase tracking-widest text-[#C87941] font-bold">
            Foundation
          </p>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-14">
          {foundation.map((item) => (
            <article
              key={item.title}
              className="rounded-xl border border-[#E8DDD4] bg-white p-6 hover:border-[#D4C4B8] hover:shadow-sm transition-all"
            >
        ...
        <section className="mb-16 rounded-2xl border border-[#E8DDD4] bg-[#FAFAF8] p-8">
          <h2 className="text-3xl font-title text-[#1A1410] mb-4">Core modules</h2>
