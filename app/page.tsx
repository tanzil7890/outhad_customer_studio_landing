...
export default function SyntheticV0PageForDeployment() {
  ...
  // Halfway target points
  const halfwayTopLeftRef = useRef<HTMLDivElement>(null)
  const halfwayTopRightRef = useRef<HTMLDivElement>(null)
  const halfwayMiddleLeftRef = useRef<HTMLDivElement>(null)
  const halfwayMiddleRightRef = useRef<HTMLDivElement>(null)
  const halfwayBottomLeftRef = useRef<HTMLDivElement>(null)
  const halfwayBottomRightRef = useRef<HTMLDivElement>(null)
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="h-screen relative overflow-hidden" ref={containerRef}>
        ...
        {/* Invisible halfway target points */}
        <div ref={halfwayTopLeftRef} className="absolute top-[35%] left-[25%] w-1 h-1 pointer-events-none" />
        <div ref={halfwayTopRightRef} className="absolute top-[35%] right-[25%] w-1 h-1 pointer-events-none" />
        <div ref={halfwayMiddleLeftRef} className="absolute top-1/2 left-[30%] w-1 h-1 pointer-events-none" />
        <div ref={halfwayMiddleRightRef} className="absolute top-1/2 right-[30%] w-1 h-1 pointer-events-none" />
        <div ref={halfwayBottomLeftRef} className="absolute bottom-[35%] left-[25%] w-1 h-1 pointer-events-none" />
        <div ref={halfwayBottomRightRef} className="absolute bottom-[35%] right-[25%] w-1 h-1 pointer-events-none" />

        {/* Animated Beams connecting cards halfway to the center */}
        <AnimatedBeam
          containerRef={containerRef}
          fromRef={aiSignalsRef}
          toRef={halfwayTopLeftRef}
          curvature={-30}
