...
export default function ConvertiveHistoryPage() {
  ...
  return (
    <div
      className="min-h-screen pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-[#FAFAF8] relative"
      style={{
    ...
    >
      ...
      <div className="absolute inset-0 bg-[#FAFAF8] opacity-90"></div>

      <div className="max-w-3xl mx-auto relative z-10">

        {/* Header */}
        <div className="text-center mb-16">
          <h1 className="text-3xl sm:text-4xl font-bold text-[#1A1410] mb-4 font-title">
            Convertive History
          </h1>
        </div>
        ...
        <div className="space-y-12">
          ...
          {/* Opening Statement */}
          <div className="mb-12">
            <p className="text-lg text-[#1A1410] leading-relaxed">
          ...
          <section className="relative">
            <h2 className="text-2xl font-bold text-[#1A1410] mb-6 font-title">
              What We Built Before
            </h2>
            <p className="text-[#9C8B7E] mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {/* Agent Studio Card */}
              <div
                className="group rounded-xl border border-[#E8DDD4] bg-white backdrop-blur-sm overflow-hidden transition hover:shadow-[0_10px_30px_rgba(0,0,0,0.25)] hover:border-[#C87941]"
              >
                <AgentStudioSlider />
                <div className="p-5">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="inline-flex items-center rounded-md bg-[#F7E4D0] border border-[#EBBF94] px-2 py-1 text-xs text-[#7A4420]">
                      Convertive Agent & Workflow Studio
                    </span>
                  </div>
                  <h3 className="text-lg font-semibold text-[#1A1410] mb-2 font-title">
                    Visual Agent Orchestration for Real Work
                  </h3>
                  <p className="text-sm leading-relaxed text-[#9C8B7E]">
                  ...
                  <div className="mt-4 flex items-center gap-3">
                    <span className="text-xs text-[#9C8B7E]">studio.tryconvertive.com</span>
                    <a
                      href="https://studio.tryconvertive.com/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="ml-auto inline-flex items-center gap-1 text-[#C87941] text-sm hover:underline underline-offset-4"
                    >
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4 flex items-center gap-3">
                    <span className="text-xs text-[#9C8B7E]">aisearch.tryconvertive.com</span>
                    <a
